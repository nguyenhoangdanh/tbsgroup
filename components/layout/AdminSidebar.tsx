  ...
  return (
    <>
      ...
      <aside className="hidden lg:flex lg:flex-shrink-0">
        <div className="flex flex-col w-64 h-full bg-white border-r border-slate-200 shadow-sm">
          {/* Header */}
          <div className="flex items-center p-6 border-b border-slate-200">
            <div className="flex items-center space-x-3">
              ...
              <span className="font-semibold text-slate-900 text-lg">Admin</span>
            </div>
          </div>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.aside
            className="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-slate-200 shadow-lg lg:hidden"
